...
export const MOCK_DATA = {
  ...
  assets: [
    { id: 'a1', asset_code: 'ATI-2024-00001', patrimonial_code: 'PAT-001', description: 'Notebook Dell Latitude 5420 i7', status: 'active', category_id: 'c1', cost_center_id: 'cc2', location_id: 'l1', responsible_id: 'u2', supplier_id: 's1', acquisition_value: 8500, acquisition_date: '2023-03-15', serial_number: 'SN-DELL-001', manufacturer: 'Dell', brand: 'Dell', model: 'Latitude 5420', observations: 'Notebook para uso do gestor de TI. Com dock station.', geo_lat: -23.55052, geo_lng: -46.633308 },
